...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-05-2019 a las 19:04:12
...
(2, '1', 'Glenis', '', 'Ramos', 'Care', '2010-05-16', 'Femenino', 'glenis@g.com', '3218374854', '1', 'Auxiliar'),
...
INSERT INTO `prestamo` (`idPrestamo`, `codigoPrestamo`, `fechaPrestamo`, `fechaLimite`, `fechaDevolucion`, `tipoPrestamo`, `idMaterial`, `idUsuario`) VALUES
(10, '1557421365390', '2019-05-09 17:02:48', '2019-05-09 19:02:48', NULL, 'Interno', 1, 2);
...
--
ALTER TABLE `prestamo`
  ADD CONSTRAINT `prestamo_ibfk_1` FOREIGN KEY (`idMaterial`) REFERENCES `material` (`idMaterial`),
  ADD CONSTRAINT `prestamo_ibfk_2` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idPersona`);
COMMIT;
